...
__MEMPOOL_POOLS_URL__=${MEMPOOL_POOLS_URL:=https://raw.githubusercontent.com/mempool/mining-pools/master/pools.json}
...
sed -i "s!__MEMPOOL_POOLS_URL__!${__MEMPOOL_POOLS_URL__}!g" mempool-config.json
